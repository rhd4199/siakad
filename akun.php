    ...
    <div class="d-flex align-items-end profile-avatar-container gap-4">
        ...
        <div class="mb-2 flex-grow-1">
            ...
            <div class="d-flex align-items-center gap-3 text-muted small">
                ...
                <span class="d-none d-md-inline"><i class="bi bi-shield-lock me-1"></i> SUPERADMIN</span>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card border-0 shadow-sm mt-3">
            <div class="card-body p-3">
                <div class="d-flex align-items-center gap-3 mb-3">
                    ...
                    <div>
                        <div class="small fw-bold">Status Akun</div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control border-start-0 ps-0" value="Superadmin" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
